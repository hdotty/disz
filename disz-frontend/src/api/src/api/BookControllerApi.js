...
export default class BookControllerApi {
    ...
    */
     ...
     * data is of type: {@link module:model/BookDto}
     */
    updateBookUsingPUT(id, book, opts, callback) {
      opts = opts || {};
      let postBody = book;
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling updateBookUsingPUT");
      }
      // verify the required parameter 'book' is set
      if (book === undefined || book === null) {
        throw new Error("Missing the required parameter 'book' when calling updateBookUsingPUT");
      }
