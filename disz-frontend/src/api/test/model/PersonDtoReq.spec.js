...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ApiDocumentation.PersonDtoReq();
  });
  ...
  describe('PersonDtoReq', function() {
    it('should create an instance of PersonDtoReq', function() {
      // uncomment below and update the code to test PersonDtoReq
      //var instance = new ApiDocumentation.PersonDtoReq();
      //expect(instance).to.be.a(ApiDocumentation.PersonDtoReq);
    });
